...
public class EmulatorHeaderValidationTestCase {
    ...
    public void testMultipleHeaderFields() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .given(HttpClientConfigBuilderContext.configure()
                               .host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user3").withMethod(HttpMethod.GET))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
        Assert.assertEquals(response.getReceivedResponseContext().getResponseStatus(), HttpResponseStatus.OK,
                            "Expected response status code not found");
    ...
    public void testSingleRequestHeaderFields() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .given(HttpClientConfigBuilderContext.configure()
                               .host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user4").withMethod(HttpMethod.GET).withHeader("Header-req-1",
                                                                                              "value-req1"))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
        Assert.assertEquals(response.getReceivedResponseContext().getResponseStatus(), HttpResponseStatus.OK,
    ...
    public void testMultipleRequestHeaderFieldsWithANDOperation() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .given(HttpClientConfigBuilderContext.configure()
                               .host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user5").withMethod(HttpMethod.GET).withHeaders(new Header
                                                                                                       ("Header-req2", "value-req2"), new Header("Header-req3", "value-req3"), new Header
                                                                                                       ("Header-req4", "value-req4")))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
        Assert.assertEquals(response.getReceivedResponseContext().getResponseStatus(), HttpResponseStatus.OK,
                            "Expected response status code not found");
    ...
    public void testMultipleRequestHeaderFieldsWithOROperation() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .given(HttpClientConfigBuilderContext.configure()
                               .host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user6").withMethod(HttpMethod.GET).withHeaders(new Header("Header-req5", "value-req5"), new Header
                                ("Header-req6",
                                 "value-req6")))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
    ...
    public void testMultipleRequestHeaderFieldsWithOROperationErrorScenario() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .given(HttpClientConfigBuilderContext.configure()
                               .host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user6").withMethod(HttpMethod.GET).withHeaders(new Header
                                                                                                       ("Header-req15", "value-req15")))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
    ...
    public void testMultipleRequestHeaderFieldsWithANDOperationErrorScenario() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator()
                ...
                .when(HttpClientRequestBuilderContext.request()
                              .withPath("/users/user5").withMethod(HttpMethod.GET).withHeaders(new Header
                                                                                                       ("Header-req2", "value-req2"), new Header("Header-req3", "value-req3"), new Header
                                                                                                       ("Header-req14", "value-req14"), new Header
                                                                                                       ("Header-req5", "value-req5")))
                .then(HttpClientResponseBuilderContext.response().assertionIgnore())
                .operation().send();
        Assert.assertEquals(response.getReceivedResponseContext().getResponseStatus(), HttpResponseStatus.NOT_FOUND,
                            "Expected response status code not found");
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator()
                ...
                .when(request()
                              .withMethod(HttpMethod.GET).withPath("user4/").withHeader("Header-req-1", "value-req1"))
                .then(response()
                              .withBody("User4")
                              .withStatusCode(HttpResponseStatus.OK)
                              .withHeader("Header5", "value5"))
                .when(request()
                              .withMethod(HttpMethod.GET).withPath("user5/").withHeaders(Operation.AND, new Header
                                ("Header-req2", "value-req2"), new Header("Header-req3", "value-req3"), new Header
                                                                                                 ("Header-req4", "value-req4")))
                .then(response()
                              .withBody("User5")
                ...
                .when(request()
                              .withMethod(HttpMethod.GET).withPath("user6/").withHeaders(Operation.OR, new Header
                                ("Header-req3", "value-req3"), new Header("Header-req5", "value-req5"), new Header
                                                                                                 ("Header-req6",
                                                                                                  "value-req6")))
                .then(response()
                              .withBody("User7")
